                    ...
                    case 2:
                        ...
                        case 2:
                            ...
                            case 1:
                                ...
                                else if (num_seats_dip_govtit == 0)
                                {
                                    printf("You have not selected any seats\n");
                                    system("cls");
                                    printf("Do you really wish to exit from taking the admission(yes or no)?:");
